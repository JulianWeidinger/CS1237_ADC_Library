...
\begin{DoxyParams}{Parameters}
{\em value} & This is a pointer to the variable, where the function should store the read value.\\
\hline
...
\index{CS1237@{CS1237}!instance\_ISR@{instance\_ISR}}
\index{instance\_ISR@{instance\_ISR}!CS1237@{CS1237}}
\doxysubsubsection{\texorpdfstring{instance\_ISR()}{instance\_ISR()}}
{\footnotesize\ttfamily void IRAM\+\_\+\+ATTR CS1237\+::instance\+\_\+\+ISR (\begin{DoxyParamCaption}\item[{void}]{ }\end{DoxyParamCaption})}



This is the hardware interrupt function of the specific instance. ~\newline
 ~\newline
 If this function is called, there is a new reading available in the ADC. ~\newline
 The flag to block the \mbox{\hyperlink{classCS1237_a376720c039ca4454203572226ff178a6}{reading()}}-\/function is set, the hardware interrupt is detached ~\newline
...
\begin{DoxyParams}{Parameters}
{\em sleep\+\_\+} & This is a local flag to either put the device in sleep mode or wake it up. \\
\hline
\end{DoxyParams}
...
\hline
{\em value} & This is a pointer to the variable where the function should store the measured analog signal.\\
\hline
{\em gain} & This is the register value of the gain, which has to be set.\\
\hline
{\em speed} & This is the register value of the sample rate, which has to be set.\\
...
{\em channel} & This is the register value of the channel, which has to be set.\\
\hline
{\em register\+\_\+value} & This is the value of the register, where all \char`\"{}handed over variables\char`\"{} are combined to get the full register values ~\newline
...
\begin{DoxyParams}{Parameters}
{\em reading\+\_\+} & the local variable for the read value\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
the read value of measured analog signal (reading\+\_\+) 
\end{DoxyReturn}
...
\hline
{\em \+\_\+interrupt\+\_\+reading\+\_\+already\+\_\+startet} & This is a flag to know, if the background reading has already started, ~\newline
 ~\newline
 to make sure the background reading will go on or stop after this function.\\
\hline
{\em offset\+\_\+} & This is the sum value for building the average.\\
\hline
{\em offset\+\_\+count\+\_\+} & This is the counter, to know whats the quantity of the offset\+\_\+-\/variabel.\\
\hline
{\em start\+\_\+time} & This is the time variable to know, when to stop the function.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
The value of the configuration register is returned as a byte variable 
