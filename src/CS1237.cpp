 ...
 * The standart ADC-coverter (HX711) has a too slow sample rate, to use in my measurement device and the chips from other 
...
/*!
    ...
    @section example_getevent Code of the function:
